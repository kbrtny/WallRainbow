...
void RGBConverter::HsvToRgb(double hue, double saturation, double value, uint16_t& red, uint16_t& green, uint16_t& blue)
{
	double r, g, b;
	...
	red = static_cast<uint16_t>(r * 4095);
	green = static_cast<uint16_t>(g * 4095);
	blue = static_cast<uint16_t>(b * 4095);
}

void RGBConverter::HsvToRgb(double hue, double saturation, double value, double& red, double& green, double& blue)
{
	double r, g, b;
